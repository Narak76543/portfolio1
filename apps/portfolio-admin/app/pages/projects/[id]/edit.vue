<template>
  <div>
    <div class="mb-6">
      ...
      <h1 class="text-2xl font-bold text-text-primary dark:text-[#F2F2F7] mt-2">Edit Project</h1>
    </div>

    <!-- Loading state -->
    <AppCard v-if="pageLoading" class="text-center py-12">
      <div class="animate-spin w-8 h-8 border-2 border-primary/20 border-t-primary rounded-full mx-auto" />
      <p class="text-sm text-text-secondary dark:text-[#8E8E93] mt-3">Loading project...</p>
    </AppCard>

    <!-- Error state -->
    <AppCard v-else-if="pageError" class="text-center py-12">
